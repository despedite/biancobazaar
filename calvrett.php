...
<div class="card" style="width: 21rem;">
  <div class="card-body">
    <h5 class="card-title">Calvrett Collection</h5>
    <h6 class="card-subtitle mb-2 text-muted">$200</h6>
    <p class="card-text">Ahora como nunca antes visto: Calvrett Collection, previamente BareiroPlaza, es una mega-recopilacion de tres surreales y, honestamente sin ningun sentido ni correlacion mas que ser humor random, juegos basados en Scratch creados alrededor de 2017 - re-hechos con nuevos graficos vectorizados, en 4K y con muchisimo mas contenido, desbloqueables, un nuevo codigo construido desde abajo y multiples opciones mas: ¡incluso con algunos finales alternativos! Incluye tres juegos: La Experiencia Brasil EX, Sam: El Videojuego y Calvrett VS. Lagraña, junto con un extra: Calvrett VS. AMD.</p>
    <?php if(isset($_SESSION['email'])) { ?>
    <a href="compra_cv1.php" class="card-link">Comprar</a>
    <?php } else { ?>
